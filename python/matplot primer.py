...
x = np.array(['Angliiski','Matematika','BEL','IT','Muzika','Geografiq','Chas na klasa','Istoriq','Biologiq','Himiq','Fizika','Informatika','Fizichesko','Filosofiq','Nemski'])
y = np.array([2,6,3,1,1,3,1,3,2,2,2,3,2,2,2])
